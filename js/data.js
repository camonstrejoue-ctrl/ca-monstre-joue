...
window.ARTICLES = [
  {
    ...
    blocks: [
      ...
      { type: 'p', text: "La première étape lorsque vous êtes bien installés autour de la table et que vous avez lu les règles (qui sont relativement faciles à apprendre !) c'est bien évidemment de choisir votre équipe ! Réfléchissez bien à la composition de votre groupe car elle va grandement influer sur la difficulté de votre expédition. Sans soigneur, gare aux bobos ! Vous ne prenez que des personnages avec peu de points de vie ? Le moindre piège peut vous être fatal. En bref, construisez votre équipe afin de parer à toutes les situations qui se présenteront à vous." },
